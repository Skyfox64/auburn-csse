   ...
   public class GradeGenerator {
      ...
      public static void main(String[] args) {
         ...
         grade.setLabAverages(actAvg, quizAvg);
         grade.setProjectAverage(projAvg);
         grade.setExamScore(Grade.EXAM_1, exam1Score);
         grade.setExamScore(Grade.EXAM_2, exam2Score);
         grade.setExamScore(Grade.FINAL, finalExamScore);
