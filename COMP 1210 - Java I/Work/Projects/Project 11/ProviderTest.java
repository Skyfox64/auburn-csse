...
public class ProviderTest {
   ...
   @Test public void addPhoneTest() throws IOException, NegativeValueException
   {
      ...
      CellPhone[] expected = {flip1, flip2, android1,
         iphone1, smartPhone1, smartPhone2};
    ...
    * @throws NegativeValueException is value is negative.
    */
   @Test public void deletePhoneTest() 
      throws IOException, NegativeValueException 
   {
      ...
      Assert.assertTrue("Test for boolean value of deletePhone",
                         p.deletePhone("111-243-6924"));
      Assert.assertFalse("Test for boolean value of deletePhone",
                         p.deletePhone("111-123-9999"));
      Assert.assertEquals("Test for addPhones", 
                           Arrays.toString(expected),
                           Arrays.toString(p.getPhones())); 
   }
   ...
   {
      p.addExcludedRecord("NotAPhone,123-456-7890,14,70");
   ...
   {
      p.deletePhone("111-243-5948");
      p.deletePhone("111-243-6924");
      p.deletePhone("111-934-9939");
