...
/**
* This class provides methods for generating reports, adding a cell
* phone, deleting a cell phone, and sorting the cell phones by
* number and by billing amount.
*
* @author John Carroll
* @version 11-21-2013
*/
      ...
      while (fileScan.hasNext()) {
         ...
         switch (type) {
            ...
            case 'S':
               ...
               SmartPhone smart = new SmartPhone(number, texts, minutes, data);
               addPhone(smart);
               break;
            ...
            case 'I':
               ...
               IPhone i = new IPhone(number, texts, minutes, data, iMessages);
               addPhone(i);
               break;
